...
<link href="css/public.css" rel="stylesheet" type="text/css">
  ...
  <!-- 套用源代码时修改对象字段值 -->
       ...
       <td colspan="8" align="center">
        ...
        <!-- 套用源代码时修改跳转的Action-->
        <s:else>
            <a href="applyDeclineShow?page=1">第一页</a>
            <a href="applyDeclineShow?page=<s:property value="%{pageBean.currentPage-1}"/>">上一页</a>
        </s:else>
        <s:if test="%{pageBean.currentPage != pageBean.totalPage}">
            <a href="applyDeclineShow?page=<s:property value="%{pageBean.currentPage+1}"/>">下一页</a>
            <a href="applyDeclineShow?page=<s:property value="pageBean.totalPage"/>">最后一页</a>
        </s:if>
        <s:else>
            下一页 最后一页
        </s:else>
