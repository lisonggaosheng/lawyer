...
<script language="javascript">
	function check(){
		...
		if(name==""){
			 alert("用户名不能为空");
			 document.form1.action="loginFali.jsp";
		}
		if(pwd==""){
			 alert("密码不能为空");
			 document.form1.action="loginFali.jsp";
  ...
  <form name="form1" method="post" action="usersLogin">
    <table width="100%" border="1">
      <tr>
        <td height="21" colspan="2"><div align="center" class="STYLE1">两高律师事务所</div></td>
      </tr>
      <tr>
        <td height="22" colspan="2"><div align="center" class="STYLE3">用户名或密码错误</div></td>
      </tr>
      <tr>
