...
<script language=javascript>
    ...
    //   yearNow = yearNow + 1900;
        var count = 0;
        for (var i = yearNow-50; i <= yearNow; i++) {
    ...
    var inputid = window.dialogArguments;
  function CheckDate(strDay) {
   ...
   if (strDay != "") {
     ...
     if (strDay.length == 1) strDay = "0"+strDay;
       ...
       if (window.opener) {
       		 fWindowText1 = window.opener.document.getElementById(inputid); 
             fWindowText1.value = strY+"年"+strM+"月"+strDay+"日"; 
       }else{
       		parent.window.returnValue = strY+"年"+strM+"月"+strDay+"日";  //将选择的日期传递到父窗口中
       }
       parent.window.close();
...
<center>
  <form name="calendar">
    <table border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="250" nowrap="nowrap" align="right"><select name="yearList" onChange="display_month(this.form)">
          </select>
        </td>
