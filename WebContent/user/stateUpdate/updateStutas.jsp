...
<table cellspacing="0" cellpadding="0" border="0" width="100%"
	...
	<tr>
					...
					$.ajax({
						...
						success:function(msg){
								...
								for(i=0 ; i<secCourts.length; i++ ){
									//将二级法院添加到树形图
									d.add(secCourts[i].lawyercourt_id+"self",firId,secCourts[i].lawyercourt_court_name+"自身","findCourts.action?court.courtcode="+secCourts[i].lawyercourt_number,"","allcourt");
					...
					$.ajax({
						...
						success:function(msg){
								...
								for(i=0 ; i<thirdCourts.length; i++ ){
									//将三级法院添加到树形图
									d.add(thirdCourts[i].lawyercourt_id,secId,thirdCourts[i].lawyercourt_court_name,"findCourts.action?court.courtcode="+thirdCourts[i].lawyercourt_number,"","allcourt");
								}
								$("#dtree").empty();
								$("#dtree").append(d.toString());
						}
		...
		<td width="950" height="900" valign="top">
			<iframe name="allcourt"  src="updateStutasByCourt.action" frameborder="0" scrolling="no" width="900" height="900"></iframe>
		</td>
	</tr>
	<tr>
		<td colspan="2"></td>
