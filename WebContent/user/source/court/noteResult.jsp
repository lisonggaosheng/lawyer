	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" width="98%" align="center"
			...
			<tr>
				...
				<form id="fenye" action="findNoteCourts.action" method="post">
...
<table cellpadding="0" cellspacing="0" border="0" align="center"
	...
	<s:iterator id="c" value="courts">
		<tr align="center">
			...
			<td><s:property value="#c.noticeCourt" /></td>
			<td><s:property value="#c.noticeTime" /></td>
			<td><s:property value="#c.lawDocumentNum" /></td>
			<td>
...
<c:if test="${userlp.lp_query_casesource_resultopts==1}">
	...
	<table cellpadding="0" cellspacing="0" border="0" align="center"
		...
		<tr>
			...
			<tr>
				<td align="center">
				<form name="noteForm" action="insertNoteExcel.action">
					<input type="file" name="upd"/><input type="button" value="导入被执行人公告信息"
					onclick="insertNoteCourts()" />
				</form>
				</td>
			</tr>
			<tr class="title">
