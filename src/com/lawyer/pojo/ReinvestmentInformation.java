...
public class ReinvestmentInformation implements Serializable{
	...
	public ReinvestmentInformation() {
		super();
	}
	public ReinvestmentInformation(String registration_mark, String litigant,
